<template>
  	<div class="login_page fillcontain">
		...
		active-text-color="#ffd04b">
			...
			<el-menu-item index="2" @click="user_reigister()">注册</el-menu-item>
		</el-menu>
...
<script>
	import {register_user} from '@/api/getData'
			...
			async submitForm(formName) {
				...
				this.$refs[formName].validate(async (valid) => {
					if (valid) {
						...
						const res = await register_user({account: this.loginForm.account, password: this.loginForm.password})
						console.log(res);
						if (res.rtCode == '0') {
							this.$message({
		                        type: 'success',
